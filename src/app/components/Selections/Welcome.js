...
const Welcome = () => {
  return (
    <section className="flex justify-center w-full" id='welcome'>
      <motion.section 
      className='flex justify-evenly flex-col md:flex-row md:w-4/5 items-center bg-slate-800/75 py-6 md:py-12 my-6 md:my-12 px-0 md:px-6 rounded drop-shadow-md' 
      initial={{opacity:0}}
      viewport={{ once: true }}
      ...
      transition={{
        ...
        <Image alt='This websites creator and subject matter, Shane Misra' src={profile} className='aspect-auto rounded m-4 drop-shadow-xl w-4/5 md:w-2/5' priority={true}/>
        <motion.div
        className="w-2/3"
        initial={{ opacity: 0}}
        whileInView={{opacity: 1}}
        ...
        <div className= "flex flex-col items-center text-emerald-950">
          <h1 className="flex justify-center text-3xl md:text-6xl py-4 px-8 mb-2 md:mb-8 bg-slate-200/90  rounded-lg">Hello!</h1>
