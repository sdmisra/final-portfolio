...
const Welcome = () => {
  return (
    <section className="flex justify-center w-full" id='welcome'>
      <motion.section 
      className='flex justify-evenly flex-col md:flex-row md:w-4/5 items-center bg-slate-700/50 py-6 md:py-12 my-6 md:my-12 px-0 md:px-6 rounded drop-shadow-md' 
      initial={{opacity:0}}
      viewport={{ once: true }}
      ...
      transition={{
        ...
        <div className= "flex flex-col items-center text-emerald-950">
          <h1 className="flex justify-center text-3xl md:text-6xl py-4 px-8 mb-2 md:mb-8 bg-slate-200/90 border-2 border-emerald-800/75  rounded-lg">Hello!</h1>
          <motion.p className='w-[90vw] md:w-4/5 my-2 md:my-4 text-sm md:text-base bg-slate-200/90 border-2 border-emerald-800/75 rounded p-2'
          ...
          <motion.p className="w-[90vw] md:w-4/5 my-2 md:my-4 text-sm md:text-base bg-slate-200/90 border-2 border-emerald-700/75  rounded p-2"
            initial={{ opacity: 0, y: 25 }}
            whileInView={{ opacity: 1, y: 0, }}
